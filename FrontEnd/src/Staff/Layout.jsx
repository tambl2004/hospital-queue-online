...
const Layout = ({ children }) => {
  ...
  const menuItems = [
    { path: '/staff/dashboard', label: 'Dashboard', icon: FaChartBar },
    { path: '/staff/appointments', label: 'Lượt đăng ký hôm nay', icon: FaClipboardList },
    { path: '/staff/queue', label: 'Gọi số', icon: FaBullhorn },
  ];
